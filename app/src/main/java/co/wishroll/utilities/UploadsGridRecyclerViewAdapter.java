...
public class UploadsGridRecyclerViewAdapter extends RecyclerView.Adapter<UploadsGridRecyclerViewAdapter.GridViewHolder> {

    private Context mContext;
    List<Post> mData;

    public UploadsGridRecyclerViewAdapter(Context mContext, List<Post> mData) {
