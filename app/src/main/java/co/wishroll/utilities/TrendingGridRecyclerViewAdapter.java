...
public class TrendingGridRecyclerViewAdapter extends RecyclerView.Adapter<TrendingGridRecyclerViewAdapter.GridViewHolder> {

    private Context mContext;
    List<Post> mData;

    public TrendingGridRecyclerViewAdapter(Context mContext, List<Post> mData) {
