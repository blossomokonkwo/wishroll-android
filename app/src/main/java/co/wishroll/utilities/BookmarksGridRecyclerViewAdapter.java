...
public class BookmarksGridRecyclerViewAdapter extends RecyclerView.Adapter<BookmarksGridRecyclerViewAdapter.GridViewHolder> {

    private Context mContext;
    List<Post> mData;

    public BookmarksGridRecyclerViewAdapter(Context mContext, List<Post> mData) {
