...
public class LikesGridRecyclerViewAdapter extends RecyclerView.Adapter<LikesGridRecyclerViewAdapter.GridViewHolder> {

    private Context mContext;
    List<Post> mData;

    public LikesGridRecyclerViewAdapter(Context mContext, List<Post> mData) {
